...
$anmeldung_turnier    = date( "d.m.Y - H:i", $db_turnier->turnieranmeldung );
$start_turnier 		  = date( "d.m.Y - H:i", $db_turnier->turnierstart );
$checkin_turnier      = date( "d.m.Y - H:i", $db_turnier->turniercheckin );
$checkin2_turnier     = date( "d.m.Y - H:i", $db_turnier->turniercheckin2 );
...
if ( $action == "tabelle" ):
    ...
    <section id="home_latest_event" class="full_width event_image_big" style="margin-top: 110px;">
                    ...
                    <div class="inner clearfix">
                        ...
                        <div class="middle">
										<p class="event_series"><?php echo $serie_turnier ?></p>
                           				<p class="event_location"><?php echo $ort_turnier ?> - <?php echo $spielstaette_turnier ?></p>
                    			        <p class="event_date"><?php echo $datum_turnier ?></p>
                                        <p class="event_info">
                                        </p>
							<table class="table table-bordered">
                        	<tr>
                            	<td width="25%" align="center"><b>Anmeldung</b></td>
                            ...
                            <tr>
                            	<td align="center"><?php echo $anmeldung_turnier ?> Uhr</td>
                                <td align="center"><?php echo $checkin_turnier ?> Uhr</td>
                                <td align="center"><?php echo $checkin2_turnier ?> Uhr</td>
                                <td align="center"><?php echo $start_turnier ?> Uhr</td>
                            </tr>
                       		</table>
							<br />
...
<?php
										if(isset($_SESSION["user_id"])):
											### Geschlossen ###
											if($time < getTurnieranmeldungVonTurniereID($turniere_id)):
												echo "<a class='button yellow'>Anmeldung noch nicht gestartet</a>";
											### Anmeldephase ###
											elseif($time >= getTurnieranmeldungVonTurniereID($turniere_id) && $time < getTurniercheckinVonTurniereID($turniere_id)):
												if(countAnmeldungenVonTurniereID($turniere_id) >= getTurnierteilnehmerVonTurniereID($turniere_id)):
													echo "<a class='button yellow'>Ausgebucht</a>";
												else:
													if(checkUseranmeldungVonTurniereID($turniere_id,$_SESSION["user_fullname"]) == 0):
														echo "<a class='button yellow' href='index.php?turnier=141&action=register'>Anmelden</a>";
													else:
														echo "<a class='button yellow' href='index.php?turnier=141&action=unregister'>Abmelden</a>";
													endif;
												endif;
											### Check-In ###
											elseif($time >= getTurniercheckinVonTurniereID($turniere_id) && $time < getTurniercheckin2VonTurniereID($turniere_id)):
												if(checkUseranmeldungVonTurniereID($turniere_id,$_SESSION["user_fullname"]) == 1):
													if(getUserCheckInStatusVonTurniereID($turniere_id,$_SESSION["user_fullname"]) == 2):
														echo "<a class='button yellow' href='index.php?turnier=141&action=checkin'>Check-In</a>";
													else:
														echo "<a class='button yellow' href='index.php?turnier=141&action=checkout'>Check-Out</a>";
													endif;
												endif;
											### Late Check-In ###
											elseif($time >= getTurniercheckin2VonTurniereID($turniere_id) && $time < getTurnierstartVonTurniereID($turniere_id)):
												if(getUserCheckInStatusVonTurniereID($turniere_id,$_SESSION["user_fullname"]) == 2):
													if(countCheckInsVonTurniereID($turniere_id) < getTurnierteilnehmerVonTurniereID($turniere_id)):
														echo "<a class='button yellow' href='index.php?turnier=141&action=latecheckin'>Late Check-In</a>";
													endif;
												endif;
											### Läuft ###
											elseif($time >= getTurnierstartVonTurniereID($turniere_id)):
												echo "<a class='button yellow'>Turnier ist gestartet!</a>";
											endif;
										else:
											echo "<a class='button yellow' href='login.php'>Login</a>";
										endif;
			 
?>
                                                             <a class="button yellow" href="/scripts/turnieronline/index.php?turnier=141&action=infos">Mehr Infos</a>
                        							<br />
                      </div>
                        ...
                        <div class="right event_mode">
                            ...
                            <img src="<?php echo $modus_turnier_link ?>">
                        							...
                        							<br />
						<div class="box table-responsive"></div>
                </div>
            </div>
        </div>
    </section>
    ...
    elseif ( getTurniermodusIDVonTurniereID( $turniere_id ) == 2 ):
		...
		for ( $i = 1; $i <= getTurnierrundenVonTurniereID( $turniere_id ) + 1; $i ++ ):
			...
			?>
            <div class="col-md-12">
                <div class="box table-responsive paarungen">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box table-responsive">
                        <table class="table table-bordered">
                        	<tr>
                            	<td width="50%" align="left"><i class="fa fa-arrow-circle-right"></i> Turnierphase</td>
                                <td width="50%" align="right"><?=getTurnierphaseVonTurniereID($turniere_id,$time)?></td>
                            </tr>
                            <tr>
                            	<td align="left"><i class="fa fa-trophy" aria-hidden="true"></i> Freie Plätze</td>
                                <td align="right"><?=($db->turnierteilnehmer - countAnmeldungenVonTurniereID($turniere_id))?></td>
                            </tr>
                            <tr>
                            	<td align="left"><i class="fa fa-check-square"></i> Check-In's</td>
                                <td align="right"><?=countCheckInsVonTurniereID($turniere_id)?></td>
                            </tr>
                            <tr>
                            	<td align="left"><i class="fa fa-users"></i> Teilnehmer</td>
                                <td align="right"><?=countAnmeldungenVonTurniereID($turniere_id)?> / <?=$db->turnierteilnehmer?></td>
                            </tr>
                            <tr>
                            	<td align="left"><i class="fa fa-cog"></i> Format</td>
                                <td align="right">
<?php
...
?>
                            ...
                            <tr>
                            	<td align="left"><i class="fa fa-male"></i> Modus</td>
                                <td align="right">
<?php
									if($db->spielmodus == 1):
										echo "1 vs. 1";
