...
$(document).ready(function() {	
	...
	//VEGAS
	/*$.vegas({src:'http://v3.fifa-transferliga.de//images/backgrounds/fifa.jpg'})('overlay', {src:'http://v3.fifa-transferliga.de//images/backgrounds/overlay.png'});*/
	
	/*$.vegas('slideshow', {
		delay:5000,
		backgrounds:[
			{ src:'http://v3.fifa-transferliga.de//images/backgrounds/fifa.jpg', fade:1500 },
	  	]
	})('overlay', {src:'http://v3.fifa-transferliga.de//images/backgrounds/overlay.png'});*/
