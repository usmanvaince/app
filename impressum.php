...
?>
	...
	<section id="impressum" style="padding-top: 120px;">
		<div class="container clearfix">
			<div class="row">
				<div class="col-md-12">
                    ...
                    <h2>Kontakt:</h2>
                    <p>Telefon: +41 79 618 15 22<br />
                        E-Mail: info@esport-event.gmbh</p>

                    <h2>Registereintrag:</h2>
                    <p>Eintragung im Handelsregister. <br />
                        Registergericht:Kanton Aargau <br />
                        Registernummer: CH-159.879.117</p>
